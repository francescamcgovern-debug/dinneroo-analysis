# Stakeholder Slides - Data Pack

**Generated:** 2026-01-07  
**Purpose:** Pastable text blocks with evidence for the Dish Analysis Dec-25 presentation  
...
> the request: "Fran to fill out rationale with data on RHS - We should have data that shows variety complaints decrease a lot after 20+ dishes, 5+ px, 5+ cuisines"
...
> the request: "Currently, X zones meet all 3 criteria"
...
> the request: "the team and Fran to fill out at end - once we have the 'final' ratings by dish"
...
> the request: "[Fran to edit: Number of times a dish is mentioned...]" and "[Fran to edit: Suitability score out of 5...]"
...
> the request: "We have identified X Core Driver dishes, Y Preference Drivers and Z Demand Boosters; ZZ can be deprioritised"
...
> the request: Fill in the Open-Text Requests column
...
> the request: "To fill in once we've done groupings"
...
> the questions: "FRAN - DO WE THINK THIS IS TOO NICHE TO INCLUDE?"
...
│ Source                  │ Sample Size │ What It Measures                    │
├─────────────────────────┼─────────────┼─────────────────────────────────────┤
│ the Zone Data        │ 1,306 zones │ Dishes, partners, cuisines by zone  │
│ the Dish Data        │ 155 dishes  │ Current Family Dinneroo menu        │
...
1. ZONE DATA RECONCILIATION
   ...
   the anna_zone_dish_counts.csv contains 1,306 zones (supply data).
...
| the zones | `DATA/3_ANALYSIS/anna_zone_dish_counts.csv` | 1,306 zones supply view |
